...
function isAlchemyRpcUrl(url) {
    try {
        ...
        return (hostname.endsWith(".alchemy.com") &&
...
function getAlchemyRpcUrlFromChainDefinition(chain) {
...
export function alchemyTransport(config) {
    ...
    const transport = (opts) => {
        ...
        const rpcUrl = (() => {
            ...
            const chainDefinitionAlchemyUrl = getAlchemyRpcUrlFromChainDefinition(chain);
