...
export declare const decodePermissionsContext: (capability: PermissionsCapability) => DecodedPermissionsContext;
export declare const prefixSignatureKeyType: (sig: Hex, type: KeySigner["type"]) => Hex;
export declare const isGlobalValidation: (data: Pick<PermissionsData, "permissions">) => boolean;
