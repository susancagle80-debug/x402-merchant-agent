import * as RpcSchemas from "./request.js";
import { z } from "../zod.js";

export const PrepareCalls = createExample(
  "wallet_prepareCalls",
  [
    {
      calls: [
  ...
  ],
  {
    ...
    data: {
      ...
      callData:
        "",
...
export const SendPreparedCalls = createExample(
...
export const RequestAccount = createExample(
...
export const ListAccounts = createExample(
  "wallet_listAccounts",
  [
    {
...
export const GetCapabilities = createExample(
...
export const CreateSession = createExample(
...
export const GetCallsStatus = createExample(
...
export const GetCrossChainStatusV0 = createExample(
...
export const PrepareSign = createExample(
  "wallet_prepareSign",
  [
    {
      from: "0xa363219d7C0b8673df17529D469Db9eFF0f35D2A",
      ...
      signatureRequest: {
        type: "personal_sign",
        data: {
          raw: "0x48656c6c6f20576f726c6421", // "Hello World!"
        },
      },
    },
  ],
...
export const FormatSign = createExample(
  "wallet_formatSign",
  [
    {
      from: "0xa363219d7C0b8673df17529D469Db9eFF0f35D2A",
...
export const RequestQuoteV0 = createExample(
...
/**
 * Creates a type-safe RPC example with schema-based type checking
 * @param method - The RPC method name (must match a key in RpcSchemas)
 * @param request - The request parameters (typed against the schema)
 * @param response - The response value (typed against the schema)
 * @returns A properly structured example object
 */
export function createExample<TMethod extends keyof typeof RpcSchemas>(
  method: TMethod,
  request: z.input<(typeof RpcSchemas)[TMethod]>["Request"]["params"],
  response: z.input<(typeof RpcSchemas)[TMethod]>["ReturnType"],
): {
  name: string;
  params: readonly [
    {
      name: "Request";
      value: z.input<(typeof RpcSchemas)[TMethod]>["Request"]["params"];
    },
  ];
  result: {
    name: "Response";
    value: z.input<(typeof RpcSchemas)[TMethod]>["ReturnType"];
  };
} {
  return {
    name: `${String(method)} example`,
    params: [
      {
