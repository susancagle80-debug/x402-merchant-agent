...
import type { SignatureOptions } from "./resources.js";
 ...
 * ```
 */
export declare function createX402Client(client: PrivyClient, { walletId, address, authorizationContext, signatureOptions }: CreateX402ClientInput): x402Client;
