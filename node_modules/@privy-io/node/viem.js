...
exports.formatViemTransaction = void 0;
exports.createViemAccount = createViemAccount;
exports.formatViemTransactionType = formatViemTransactionType;
const accounts_1 = require("viem/accounts");
const utils_1 = require("viem/utils");
const error_1 = require("./core/error.js");
const viem_tempo_1 = require("./internal/viem-tempo.js");
const viem_1 = require("./internal/utils/viem.js");
/**
 ...
 */
function createViemAccount(client, { walletId, address, authorizationContext, signatureOptions }) {
    return (0, accounts_1.toAccount)({
        ...
        signTransaction: async (transaction) => {
            const { signed_transaction: signedTransaction } = await client
                ...
                params: { transaction: (0, exports.formatViemTransaction)(transaction) },
                ...(authorizationContext ? { authorization_context: authorizationContext } : {}),
            });
...
function formatViemTransactionType(type) {
    if (type === 'legacy') {
        return 0;
    }
...
const formatViemTransaction = (tx) => {
    if ((0, viem_tempo_1.isTempoTransaction)(tx)) {
        return (0, viem_tempo_1.formatTempoTransaction)(tx);
    }
    const standardTx = tx;
    return {
        ...
        ...(standardTx.value ? { value: (0, viem_1.formatViemQuantity)(standardTx.value) } : {}),
        ...(standardTx.gas ? { gas_limit: (0, viem_1.formatViemQuantity)(standardTx.gas) } : {}),
        ...(standardTx.gasPrice ? { gas_price: (0, viem_1.formatViemQuantity)(standardTx.gasPrice) } : {}),
        ...(standardTx.maxFeePerGas ? { max_fee_per_gas: (0, viem_1.formatViemQuantity)(standardTx.maxFeePerGas) } : {}),
        ...(standardTx.maxPriorityFeePerGas ?
            { max_priority_fee_per_gas: (0, viem_1.formatViemQuantity)(standardTx.maxPriorityFeePerGas) }
            : {}),
    };
};
exports.formatViemTransaction = formatViemTransaction;
