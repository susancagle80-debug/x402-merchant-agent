...
import { formatTempoTransaction, isTempoTransaction } from "./internal/viem-tempo.mjs";
import { formatViemQuantity } from "./internal/utils/viem.mjs";
/**
 ...
 */
export function createViemAccount(client, { walletId, address, authorizationContext, signatureOptions }) {
    return toAccount({
        address: address,
        sign: async ({ hash }) => {
...
export function formatViemTransactionType(type) {
    if (type === 'legacy') {
        return 0;
    }
 ...
 */
export const formatViemTransaction = (tx) => {
