import { SolanaSignAndSendTransactionRpcResponseData, SolanaSignMessageRpcResponseData, SolanaSignTransactionRpcResponseData, WalletRpcParams } from "../../resources.mjs";
...
export declare class PrivySolanaService {
    ...
    signMessage(walletId: string, { message, ...input }: PrivySolanaService.SignMessageInput): Promise<SolanaSignMessageRpcResponseData>;
    signTransaction(walletId: string, { transaction, ...input }: PrivySolanaService.SignTransactionInput): Promise<SolanaSignTransactionRpcResponseData>;
    signAndSendTransaction(walletId: string, { transaction, ...input }: PrivySolanaService.SignAndSendTransactionInput): Promise<SolanaSignAndSendTransactionRpcResponseData>;
}
/**
