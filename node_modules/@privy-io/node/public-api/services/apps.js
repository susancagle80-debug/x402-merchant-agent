...
exports.PrivyAppsService = void 0;
const apps_1 = require("../../resources/apps/apps.js");
class PrivyAppsService extends apps_1.Apps {
    ...
    async getTestAccessToken(params) {
        ...
        if (params && 'email' in params) {
            ...
            if (!account) {
                throw new Error(`No test account found with email "${params.email}". Available: ${testAccounts
                    .map((a) => a.email)
                    .join(', ')}`);
            }
        }
            ...
            if (!account) {
                throw new Error(`No test account found with phone number "${params.phone_number}". Available: ${testAccounts
        ...
        const authResponse = await this._client.post('/v1/passwordless/authenticate', {
...
exports.PrivyAppsService = PrivyAppsService;
