...
import { Wallet, WalletCreateParams, WalletExportParams, WalletRawSignParams, RawSignResponseData, WalletRpcParams, WalletRpcResponse, Wallets, WalletSubmitImportParams, WalletUpdateParams, WalletTransferParams, HDSubmitInput, PrivateKeySubmitInput } from "../../resources.js";
import { TransferActionResponse } from "../../resources/wallets/actions.js";
import { PrivyClient } from "../PrivyClient.js";
import { PrivyEarnService } from "./earn/index.js";
import { PrivyEthereumService } from "./ethereum.js";
import { PrivySolanaService } from "./solana.js";
import { PrivyTronService } from "./tron.js";
import { PrivySwapsService } from "./swaps.js";
import { Prettify, WithAuthorization, WithExpiry, WithIdempotency } from "./types.js";
export declare class PrivyWalletsService extends Wallets {
    ...
    earn(): PrivyEarnService;
    ethereum(): PrivyEthereumService;
    solana(): PrivySolanaService;
    tron(): PrivyTronService;
    swaps(): PrivySwapsService;
    ...
    transfer(walletId: string, { authorization_context: authorizationContext, ...params }: PrivyWalletsService.TransferInput): Promise<TransferActionResponse>;
    /**
    ...
    exportPrivateKey(walletId: string, params: PrivyWalletsService.ExportPrivateKeyInput): Promise<PrivyWalletsService.ExportResponse>;
    exportSeedPhrase(walletId: string, params: PrivyWalletsService.ExportSeedPhraseInput): Promise<PrivyWalletsService.ExportSeedPhraseResponse>;
...
export declare namespace PrivyWalletsService {
    ...
    type TransferInput = Prettify<WithAuthorization<WalletTransferParams>>;
    ...
    type ExportPrivateKeyInput = Prettify<Omit<ExportInput, 'export_seed_phrase'>>;
    /** The input type for the {@link PrivyWalletsService.exportSeedPhrase} method. */
    type ExportSeedPhraseInput = Prettify<Omit<ExportInput, 'export_seed_phrase'>>;
    /** The response type for the {@link PrivyWalletsService.exportSeedPhrase} method. */
    type ExportSeedPhraseResponse = {
        seed_phrase: string;
    };
    type ImportInputWallet = Prettify<(Omit<HDSubmitInput, 'encapsulated_key' | 'ciphertext' | 'encryption_type'> | Omit<PrivateKeySubmitInput, 'encapsulated_key' | 'ciphertext' | 'encryption_type'>) & {
