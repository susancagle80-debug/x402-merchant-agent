 ...
 */
export type FiatOnrampProvider = 'meld' | 'meld-sandbox' | 'moonpay' | 'moonpay-sandbox' | 'coinbase' | 'coinbase-sandbox' | 'stripe' | 'stripe-sandbox';
/**
