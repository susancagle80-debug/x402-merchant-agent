...
import * as SwapsAPI from "../swaps.mjs";
 ...
 */
export declare class Swap extends APIResource {
    /**
     ...
     * ```
     */
    execute(walletID: string, params: SwapExecuteParams, options?: RequestOptions): APIPromise<ActionsAPI.SwapActionResponse>;
    /**
     ...
     * ```
     */
    quote(walletID: string, params: SwapQuoteParams, options?: RequestOptions): APIPromise<SwapsAPI.SwapQuoteResponse>;
}
...
//# sourceMappingURL=swap.d.mts.map