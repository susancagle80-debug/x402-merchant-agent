...
import * as IncentiveAPI from "./incentive.js";
import { Incentive, IncentiveClaimParams } from "./incentive.js";
import { APIPromise } from "../../../../core/api-promise.js";
import { RequestOptions } from "../../../../internal/request-options.js";
/**
 * Operations related to wallet actions
 */
export declare class Ethereum extends APIResource {
    _incentive: IncentiveAPI.Incentive;
    /**
     ...
     * ```
     */
    _deposit(walletID: string, params: EthereumDepositParams, options?: RequestOptions): APIPromise<ActionsAPI.EarnDepositActionResponse>;
    /**
     ...
     * ```
     */
    _withdraw(walletID: string, params: EthereumWithdrawParams, options?: RequestOptions): APIPromise<ActionsAPI.EarnWithdrawActionResponse>;
}
...
export declare namespace Ethereum {
    export { type EthereumDepositParams as EthereumDepositParams, type EthereumWithdrawParams as EthereumWithdrawParams, };
