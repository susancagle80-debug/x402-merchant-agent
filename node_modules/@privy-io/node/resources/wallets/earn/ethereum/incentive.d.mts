 ...
 */
export declare class Incentive extends APIResource {
    /**
     ...
     * ```
     */
    _claim(walletID: string, params: IncentiveClaimParams, options?: RequestOptions): APIPromise<ActionsAPI.EarnIncentiveClaimActionResponse>;
}
...
//# sourceMappingURL=incentive.d.mts.map