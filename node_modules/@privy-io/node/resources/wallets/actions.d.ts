 ...
 * Status of a custodian transaction step in a wallet action.
 */
export type CustodianTransactionWalletActionStepStatus = 'preparing' | 'queued' | 'custodian_reviewing' | 'pending' | 'confirmed' | 'rejected' | 'failed';
/**
 ...
 * Status of an SVM step in a wallet action.
 */
export type SvmWalletActionStepStatus = 'preparing' | 'queued' | 'pending' | 'confirmed' | 'rejected' | 'reverted' | 'failed';
/**
 ...
 * Status of a TVM (Tron) step in a wallet action.
 */
export type TvmWalletActionStepStatus = 'preparing' | 'queued' | 'pending' | 'confirmed' | 'rejected' | 'reverted' | 'failed';
/**
 ...
 */
export type WalletActionResponse = SwapActionResponse | TransferActionResponse | EarnDepositActionResponse | EarnWithdrawActionResponse | EarnIncentiveClaimActionResponse | EarnFeeCollectActionResponse;
/**
 * Status of a wallet action.
 */
 ...
 */
export type WalletActionStep = EvmTransactionWalletActionStep | EvmUserOperationWalletActionStep | SvmTransactionWalletActionStep | TvmTransactionWalletActionStep | ExternalTransactionWalletActionStep | CustodianTransactionWalletActionStep;
/**
 * Type of a wallet action step.
 */
export type WalletActionStepType = 'evm_transaction' | 'evm_user_operation' | 'svm_transaction' | 'tvm_transaction' | 'external_transaction' | 'custodian_transaction';
/**
 * Type of wallet action
 */
export type WalletActionType = 'swap' | 'transfer' | 'earn_deposit' | 'earn_withdraw' | 'earn_incentive_claim' | 'earn_fee_collect';
