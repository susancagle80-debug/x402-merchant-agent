 ...
 */
export type KrakenEmbedAssetSortOption = 'trending' | 'market_cap_rank' | '-market_cap_rank' | 'symbol' | '-symbol' | 'name' | '-name' | 'change_percent_1h' | '-change_percent_1h' | 'change_percent_24h' | '-change_percent_24h' | 'change_percent_7d' | '-change_percent_7d' | 'change_percent_30d' | '-change_percent_30d' | 'change_percent_1y' | '-change_percent_1y' | 'listing_date' | '-listing_date';
/**
...
export interface KrakenEmbedGetEarnAssetsResult {
    assets: {
        [key: string]: KrakenEmbedEarnAsset;
    };
}
/**
 ...
 */
export type KrakenEmbedIdentityDocumentType = 'passport' | 'drivers_license' | 'id_card' | 'residence_card' | 'special_permanent_residence_card';
/**
 * A string-encoded boolean query parameter on including current day profit and
 * loss.
 */
 ...
 */
export type KrakenEmbedResidenceDocumentType = 'bank_statement' | 'credit_card_statement' | 'employer_letter_or_work_contract' | 'government_issued_document' | 'home_or_rental_insurance' | 'internet_or_cable_bill' | 'mobile_phone_bill' | 'mortgage_statement' | 'official_government_letter' | 'passport_address_page' | 'rental_or_lease_agreement' | 'residence_certificate' | 'social_insurance_payment_receipt' | 'tax_receipt' | 'tax_return' | 'utility_bill' | 'other';
/**
 * Sort direction for paginated transaction lists.
 */
 ...
 */
export type KrakenEmbedStartVerificationURLInput = KrakenEmbedStartIdentityVerificationURLInput | KrakenEmbedStartAddressVerificationURLInput | KrakenEmbedStartLivenessVerificationURLInput;
/**
