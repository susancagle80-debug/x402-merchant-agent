 ...
 * Error codes for the device authorization pending response per RFC 8628.
 */
export type OAuthTokenDeviceCodePendingErrorCode = 'authorization_pending' | 'slow_down' | 'access_denied' | 'expired_token';
/**
 ...
 */
export type OAuthTokenGrantType = 'authorization_code' | 'urn:ietf:params:oauth:grant-type:device_code' | 'refresh_token';
/**
 ...
 */
export type OAuthTokenRequestBody = OAuthTokenAuthorizationCodeRequestBody | OAuthTokenDeviceCodeRequestBody | OAuthTokenRefreshTokenRequestBody;
/**
