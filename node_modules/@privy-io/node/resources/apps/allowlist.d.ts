...
export type AllowlistCreateParams = AllowlistCreateParams.EmailInviteInput | AllowlistCreateParams.EmailDomainInviteInput | AllowlistCreateParams.WalletInviteInput | AllowlistCreateParams.PhoneInviteInput;
export declare namespace AllowlistCreateParams {
    interface EmailInviteInput {
        type: 'email';
        value: string;
    }
    interface EmailDomainInviteInput {
        type: 'emailDomain';
        /**
         * An email domain.
         */
...
export type AllowlistDeleteParams = AllowlistDeleteParams.EmailInviteInput | AllowlistDeleteParams.EmailDomainInviteInput | AllowlistDeleteParams.WalletInviteInput | AllowlistDeleteParams.PhoneInviteInput;
