...
export declare class Intents extends APIResource {
     ...
     * ```
     */
    createPolicyRule(policyID: string, params: IntentCreatePolicyRuleParams, options?: RequestOptions): APIPromise<RuleMutateIntentResponse>;
    /**
     ...
     * ```
     */
    deletePolicyRule(ruleID: string, params: IntentDeletePolicyRuleParams, options?: RequestOptions): APIPromise<RuleDeleteIntentResponse>;
    /**
     ...
     * ```
     */
    transfer(walletID: string, params: IntentTransferParams, options?: RequestOptions): APIPromise<TransferIntentResponse>;
    /**
     ...
     * ```
     */
    updatePolicyRule(ruleID: string, params: IntentUpdatePolicyRuleParams, options?: RequestOptions): APIPromise<RuleMutateIntentResponse>;
    /**
 ...
 * quorum.
 */
export type IntentAuthorizationMember = IntentAuthorizationUserMember | IntentAuthorizationKeyMember | IntentAuthorizationKeyQuorum;
/**
 ...
 * Current status of an intent.
 */
export type IntentStatus = 'pending' | 'processing' | 'executed' | 'failed' | 'expired' | 'rejected' | 'dismissed';
/**
 * Type of intent.
 */
...
export type IntentRpcParams = IntentRpcParams.EthereumSignTransactionRpcInput | IntentRpcParams.EthereumSendTransactionRpcInput | IntentRpcParams.EthereumPersonalSignRpcInput | IntentRpcParams.EthereumSignTypedDataRpcInput | IntentRpcParams.EthereumSecp256k1SignRpcInput | IntentRpcParams.EthereumSign7702AuthorizationRpcInput | IntentRpcParams.EthereumSignUserOperationRpcInput | IntentRpcParams.EthereumSendCallsRpcInput | IntentRpcParams.SolanaSignTransactionRpcInput | IntentRpcParams.SolanaSignAndSendTransactionRpcInput | IntentRpcParams.SolanaSignMessageRpcInput | IntentRpcParams.SparkTransferRpcInput | IntentRpcParams.SparkGetBalanceRpcInput | IntentRpcParams.SparkTransferTokensRpcInput | IntentRpcParams.SparkGetStaticDepositAddressRpcInput | IntentRpcParams.SparkGetClaimStaticDepositQuoteRpcInput | IntentRpcParams.SparkClaimStaticDepositRpcInput | IntentRpcParams.SparkCreateLightningInvoiceRpcInput | IntentRpcParams.SparkPayLightningInvoiceRpcInput | IntentRpcParams.SparkSignMessageWithIdentityKeyRpcInput | IntentRpcParams.SparkWithdrawRpcInput | IntentRpcParams.SparkGetWithdrawalFeeQuoteRpcInput | IntentRpcParams.TronSignTransactionRpcInput | IntentRpcParams.TronSendTransactionRpcInput | IntentRpcParams.ExportPrivateKeyRpcInput | IntentRpcParams.ExportSeedPhraseRpcInput;
