 ...
 * Operator to use for policy conditions.
 */
export type ConditionOperator = 'eq' | 'gt' | 'gte' | 'lt' | 'lte' | 'in' | 'in_condition_set' | 'contains' | 'starts_with' | 'ends_with';
/**
 ...
 * Supported fields for Ethereum typed data domain conditions.
 */
export type EthereumTypedDataDomainConditionField = 'chainId' | 'verifyingContract' | 'chain_id' | 'verifying_contract';
/**
 ...
 * instruction fields.
 */
export type SolanaSystemProgramInstructionConditionField = 'instructionName' | 'Transfer.from' | 'Transfer.to' | 'Transfer.lamports';
/**
 ...
 * condition.
 */
export type TempoTransactionConditionField = 'fee_token' | 'fee_payer_signature' | 'nonce_key' | 'valid_before' | 'valid_after';
/**
 ...
 * in format "TransactionType.field_name".
 */
export type TronTransactionConditionField = 'TransferContract.to_address' | 'TransferContract.amount' | 'TriggerSmartContract.contract_address' | 'TriggerSmartContract.call_value' | 'TriggerSmartContract.token_id' | 'TriggerSmartContract.call_token_value';
/**
 * The typed data structure containing EIP-712 types and the primary type for typed
 * data message policy conditions.
 */
